...
Using the most parsimonious model,  Escapement in `r boots$summary[nrow(boots$summary)-1, "year"]` was `r round(boots$summary[nrow(boots$summary)-1, "escapement"], 0)` salmon (Table \@ref(tab:summary-table)).
